...
Text graphw/2,graphh/2+40,"Your current hi-score = " + hiscore,True
Flip
Forever
...
If playerscore > hiscore Then ;If player has beaten the current hi-score
	Text graphw/2,graphh/2+20,"NEW HI-SCORE! = "+playerscore,True
	;Save the hiscore
	If hiwrite=1
		file = WriteFile("hs.dat")
		If file <> 0 Then
...
Else
	...
	Text graphw/2,graphh/2+20,"Current hi-score: "+hiscore,True
EndIf
Text graphw/2,graphh/2+40,"To restart, press ENTER, or ESC to quit",True
Flip
Forever
